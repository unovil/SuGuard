    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            SuGuardTheme {
                ...
                if (authSharedViewModel.sessionStatus is SessionStatus.Authenticated) {
                    val intentToAct = Intent(LocalContext.current, HomeActivity::class.java)
                    LocalContext.current.startActivity(intentToAct)
                }
